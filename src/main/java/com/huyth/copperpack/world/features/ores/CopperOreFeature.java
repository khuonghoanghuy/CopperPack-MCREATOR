...
public class CopperOreFeature extends OreFeature {
	public static final CopperOreFeature FEATURE = (CopperOreFeature) new CopperOreFeature().setRegistryName("copperpack:copper_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(CopperOreFeatureRuleTest.INSTANCE, CopperpackModBlocks.COPPER_ORE.defaultBlockState(), 7))
	...
	private static class CopperOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<CopperOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("copperpack:copper_ore_match"), () -> codec);
