...
public class ReddyBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final ReddyBiomeLeaveDecorator INSTANCE = new ReddyBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("reddy_biome_tree_leave_decorator");
