...
public class WoolBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final WoolBiomeLeaveDecorator INSTANCE = new WoolBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wool_biome_tree_leave_decorator");
